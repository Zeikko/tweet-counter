 ...
 */
class SearchPhrase extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('id, group_id, search_phrase', 'required'),
			array('id, group_id', 'numerical', 'integerOnly'=>true),
			array('search_phrase', 'length', 'max'=>64),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, group_id, search_phrase', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'tweets' => array(self::HAS_MANY, 'Tweet', 'search_phrase_id'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('search_phrase',$this->search_phrase,true);
